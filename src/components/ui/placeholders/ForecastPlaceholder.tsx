const ForecastHourPlaceholder = () => {
  ...
  return (
    <>
      <div
        className={`h-fit backdrop-blur-3xl rounded-2xl shadow-md p-4 animate-pulse border border-slate-700 mt-6 select-none`}
      >
        <div>
        ...
        <div className="flex my-2.5 overflow-x-scroll scrollbar-hide">
          {hours.map((_) => {
            return (
              <>
                <div className="flex flex-col gap-2 px-2.5 py-3 text-sm font-normal text-slate-500 items-center cursor-default justify-center">
